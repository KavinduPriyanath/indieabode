                ...
                <div class="report-container">
                    <div class="reprot-header">
                        <div class="report-name">
                            Prasad Darshana (Game Jam Organizer)<br>
...
<!-- 
                    ...
                    <div class="report-details">
                        <div class="host-jam-report report-all">

                            <table>
                                <div class="table-topic">Hosted Jams</div>
                                <div class="list-items">
                                    <ul>
                                        <li><span class="circle green"></span>Ongoing</li>
                                        <li><span class="circle yellow"></span>Finished</li>
                                        <li><span class="circle blue"></span>Not Yet Started</li>
                                    </ul>
                                </div>
                                <thead>
                                    <tr>
