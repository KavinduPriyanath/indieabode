                    ...
                    <table>
                        ...
                        <tbody>
                            <?php foreach ($this->allgames as $game) { ?>
                                <tr class="<?php echo $game['gamePrice'] == 0 ? 'free-game' : 'paid-game'; ?>">
                                    <td><?php echo $game['gameID']; ?></td>
                                    <td><?php echo $game['gameName']; ?></td>
                                    <td><?php echo $game['releaseStatus']; ?></td>
                                    <td><?php echo $game['gameDeveloperID']; ?></td>
                                    <td><?php echo $game['views']; ?></td>
                                    <td><?php echo $game['downloads']; ?></td>
                                    <td><?php echo $game['ratings']; ?></td>
                                    <td>$<?php echo $game['revenue']; ?></td>
                                    <td><?php echo $game['gamePrice'] == 0 ? 'Free' : '$' . $game['gamePrice']; ?></td>
                                    <td class="total-income"><?php echo $game['gamePrice'] == 0 ? '-' : '$' . $game['downloads'] * $game['gamePrice']; ?></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
