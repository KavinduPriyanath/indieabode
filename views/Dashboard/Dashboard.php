...
<body>
    ...
    <?php } else if (isset($_SESSION['logged']) && $_SESSION['userRole'] == "asset creator") { ?>
    ...
    <?php } else if (isset($_SESSION['logged']) && $_SESSION['userRole'] == "gamejam organizer") { ?>
        <div class="organizer-dashboard">
            <div class="top-row">
                <div class="heading">Organizer Dashboard</div>
                <div class="dev-main-stat">
    ...
    <?php } else if (isset($_SESSION['logged']) && $_SESSION['userRole'] == "game publisher") { ?>
        <div class="publisher-dashboard">
            ...
            <div class="tabs-row">
                ...
                <a href="/indieabode/dashboard/gigs">Gig Orders</a>
                <a href="/indieabode/dashboard/sales">Sales&nbsp;&&nbsp;Bundles</a>
                <a href="/indieabode/dashboard/analytics">Analytics</a>
                <a href="/indieabode/dashboard/payouts">Payouts</a>
