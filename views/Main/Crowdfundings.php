...
<body>
    ...
    <div class="upper-break">
        ...
        <form action="/indieabode/crowdfundings" method="GET" name="myForm" id="myForm">
    ...
    <script>
        <?php if (isset($_GET['sortWhat'])) { ?>
            document.getElementById("pagination-crowdfunds").style.display = "none";
        <?php } ?>
