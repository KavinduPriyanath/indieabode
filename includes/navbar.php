...
<body>
    <div class="navbar">
        ...
        <?php if (isset($_SESSION['id']) && $_SESSION['userRole'] == "game developer") { ?>
        ...
        <?php } else if (isset($_SESSION['id']) && $_SESSION['userRole'] == "gamer") { ?>
            <div class="navbar-links">
                <div class="ul">
                    <div class="dropdown" data-dropdown>
                        <a href="<?php echo BASE_URL; ?>games" data-dropdown-button>Games<i class="fa fa-angle-down droparrow"></i></a>
        ...
        <?php } else if (isset($_SESSION['id']) && $_SESSION['userRole'] == "asset creator") { ?>
            <div class="navbar-links">
                <div class="ul">
        ...
        <?php } else if (isset($_SESSION['id']) && $_SESSION['userRole'] == "gamejam organizer") { ?>
            <div class="navbar-links">
                <div class="ul">
        ...
        <?php } else if (isset($_SESSION['id']) && $_SESSION['userRole'] == "game publisher") { ?>
            <div class="navbar-links">
                <div class="ul">
                    <div class="dropdown" data-dropdown>
                        <a href="<?php echo BASE_URL; ?>games" data-dropdown-button>Games<i class="fa fa-angle-down droparrow"></i></a>
        ...
        <?php } else if (isset($_SESSION['id']) && $_SESSION['userRole'] == "admin") { ?>
        <?php } else { ?>
            <div class="navbar-links">
                <div class="ul">
                    <div class="dropdown" data-dropdown>
